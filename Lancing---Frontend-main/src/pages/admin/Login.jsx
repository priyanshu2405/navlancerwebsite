...
const AdminLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (email === 'admin@navlancer.com' && password === 'admin123') {
                const dummyAdmin = { id: 'admin-001', name: 'System Admin', email: 'admin@navlancer.com', role: 'admin', profileCompleted: true };
            ...
            if (response.ok) {
                if (data.user.role === 'admin') {
                    ...
                    setError('Access Denied: Specialized Administrative Login Only.');
                    setIsLoading(false);
                }
            } else {
        ...
        <div className="min-h-screen bg-bg-dark flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="bg-bg-card border border-white/5 p-10 rounded-[2.5rem] backdrop-blur-xl relative overflow-hidden">
                    ...
                    <p className="text-text-muted text-center mb-10 text-sm font-medium">Authorized Personnel Access Only</p>
